...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  App.prototype.render = function render() {
	    ...
	    var BubbleSource = (0, _filterGroup2.default)(_source, 'metric', {
	      'value': 'sum',
	      'metric': 'group by'
	    });
	    ...
	    return _react2.default.createElement(_src.Bubble, {
	      ...
	      margin: [20, 20, 20, 20],
	      source: BubbleSource.data,
	      groupAxis: 'metric',
	      groupAxisDomain: BubbleSource.columns,
	      sizeAxis: 'value',
	      timebarShow: true,
